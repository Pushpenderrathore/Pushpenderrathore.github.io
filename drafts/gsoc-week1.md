...
**`metadata`** — a five-field summary: Subject, Issuer, Not Before, Not After, SHA-256 fingerprint. Fast, low-noise, useful in automation.
...
**`full`** — everything above plus serial, version, public key type/size, identity resolution (UPN > Email > CN), SAN, EKU, Key Usage, and a decoded extension dump.
